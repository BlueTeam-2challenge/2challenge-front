  ...
  return (
      <Container className="container">
          ...
          <Card className="card" style={{backgroundColor: 'white'}}>
              ...
              <Card.Title className="card-title"><Logo variant="default"/></Card.Title>
              <Card.Text className="card-text"> SIGN IN</Card.Text>
              <Card.Subtitle className="card-subtitle">Enter your credentials to access your account</Card.Subtitle>
