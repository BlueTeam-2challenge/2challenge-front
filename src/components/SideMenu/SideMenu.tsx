...
const SideMenu = ({ toggleHamburger, toggleMenu }: SideMenuProps) => {
  ...
  return (
    <>
      <div
        className={`${styles.sidebar} ${hamburger ? styles.nav : styles.side} ${
          menu ? styles.sideHide : ""
        }`}
      >
        <div
          className={`${styles.sideContent} ${hamburger ? styles.hide : ""} ${
            menu ? styles.contentHide : ""
          }`}
        >
          <Logo variant="small" />
